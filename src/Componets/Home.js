...
<div className="full_details">
        <div className="left_side">
            <div className="lists">
                <div className="profile"><img src={require('./images/2.jpg')} /><span>Dhivakar P</span></div>
                ...
                <div className="profile"><img src={require('./images/images.jpg')} /><span>Dhivakar</span></div>
            ...
            <div className="box_content">
                <div className="centerhead">
                    ...
                    <div className="name12" >
                        <a href=""><h3>Sakthivel D<span><i className="fa fa-ellipsis-h" aria-hidden="true"></i><i className="fa fa-times" aria-hidden="true"></i></span></h3></a>
...
<br></br>
            ...
            <div className="box_content">
               <h4>Suggested for you</h4>
                ...
                <div className="centerhead">
                    <a href="" id="images1"><img src={require('./images/2.jpg')} width="50px" height="50px" /></a>
                    <div className="name12" >
                        <a href=""><h3>Sonthosh <span><i className="fa fa-ellipsis-h" aria-hidden="true"></i><i className="fa fa-times" aria-hidden="true"></i></span></h3></a>
            ...
            <div className="box_content">
                <h4>Suggested for you</h4>
                 ...
                 <div className="centerhead">
                     ...
                     <div className="name12" >
                         <a href=""><h3>Sathish  <span><i className="fa fa-ellipsis-h" aria-hidden="true"></i><i className="fa fa-times" aria-hidden="true"></i></span></h3></a>
                         <p>June 17 06 2023 <i className="fa fa-users" aria-hidden="true"></i></p>
                     </div>
                 </div>
                     <div className="borders2"></div>
        ...
        <div className="right_side">
            ...
            <div className="lis">
                <div className="profile"><img src={require('./images/3.jpg')} /><span>Dhivakar P</span></div>
                <div className="profile"><img src={require('./images/4.jpg')} /><span>Arun</span></div>
                <div className="profile"><img src={require('./images/5.jpg')} /><span>Karthick</span></div>
                <div className="profile"><img src={require('./images/6.jpg')} /><span>Rajesh</span></div>
                <div className="profile"><img src={require('./images/7.jpg')} /><span>Perumal</span></div>
                <div className="profile"><img src={require('./images/8.jpg')} /><span>Divya S</span></div>
                <div className="profile"><img src={require('./images/9.jpg')} /><span>Murali A</span></div>
                <div className="profile"><img src={require('./images/download (1).png')} /><span>Sathya</span></div>
                <div className="profile"><img src={require('./images/download (2).png')}/><span>Kathir</span></div>
                <div className="profile"><img src={require('./images/download (3).png')}/><span>Subash.S</span></div>
                <div className="profile"><img src={require('./images/download (4).png')}/><span>Santhiya</span></div>
                <div className="profile"><img src={require('./images/download (5).png')} /><span>Kowsiliya</span></div>
                <div className="profile"><img src={require('./images/download (6).png')} /><span>Deivane</span></div>
                <div className="profile"><img src={require('./images/download (7).png')} /><span>Sakthivel</span></div>
                <div className="profile"><img src={require('./images/download (8).png')} /><span>Harish</span></div>
                <div className="profile"><img src={require('./images/4.jpg')} /><span>Kamali.K</span></div>
                <div className="profile"><img src={require('./images/5.jpg')} /><span>Suvithra.S</span></div>
                <div className="profile"><img src={require('./images/6.jpg')} /><span>Komath.s</span></div>
                <div className="profile"><img src={require('./images/8.jpg')} /><span>Kavitha</span></div>
                <div className="profile"><img src={require('./images/5.jpg')} /><span>Siva Kumar</span></div>
                <div className="profile"><img src={require('./images/9.jpg')} /><span>Kamesh Kumar</span></div>
                <hr></hr>
            </div>
        </div>
